...
<section class="flex inline-flex">
    ...
    <?php $imageurl = '<html><img src="http://localhost/app/rumuseum/public/img/banner1.jpeg"></html>'; ?>
   <a href="javascript:showImage( '<?php echo e($imageurl); ?> ')">Photo1</a> </div>
   <a href="javascript:newWindow( '<?php echo e(env('APP_URL')); ?>'  )">new Window</a>
    <iframe src="<?php echo e(env('APP_URL')); ?>/bookframe.html" name="book1" class=" border-gray-100 shadow m-2 w-[300px] h-[300px]">book1</iframe>
</section>
...
<div class="row pb-0 ">
    <div class="">
        <h3 class="banner__header text-3xl font-bold pl-10 ">
            <a href="<?php echo e(url('')); ?>"><?php echo e(__('sections.books')); ?>  </a>
        </h3>
    </div>
</div>
