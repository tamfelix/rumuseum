...
<html lang="<?php echo e(str_replace('_', '-', $locale)); ?>">
    <head>
        <meta charset="utf-8">
        ...
        <style>
            ...
            /* BANNER 1 */
            .banner{
                background:url(<?php echo e(env('APP_URL').'/img/banner1.jpeg'); ?>);
            }
            .banner__header{
                color:var(--h-color4);
            }
...
<nav class="flex inline-flex justify-between w-full">
    <div class="jumbotron jumbotron-fluid p-3 pl-3">
        <h1 class="text-3xl font-bold">
            <a href="<?php echo e(env('APP_URL')); ?>">
                <?php echo e(__('sections.museum')); ?>

            </a>
        </h1>
        <p class=" mb-4 ">
            <a href="javascript:logging()"><?php echo e(__('sections.slavistics')); ?></a>
        </p>
    </div>
    <div class="relative flex items-top justify-center  sm:items-center py-4 sm:pt-0 ml-4 " >
        <a class="mx-2">Collections</a>
        <a class="mx-2">Assets</a>
        <a class="text-lg text-[#9fb16fb1] mx-2" >About project</a>
    </div>
</nav>
    <!-- NAV MENU -->
        ...
        <div class=" inline-flex mb-4 ml-4 items-center my-auto ">
            ...
            <ul class="  flex inline-flex p-0">
                <?php $__currentLoopData = $menuitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="  " href="<?php echo e(route('pages.show', $item['id'])); ?>">
            ...
            <div class="mx-2 my-auto p-auto ">
                <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(request()->url()); ?>?language=<?php echo e($area); ?>"
                       class="<?php if( app()->getLocale() == $area ): ?> border-b border-white border-b-2  <?php endif; ?> inline-flex items-center px-1 my-auto">
                        <?php echo e(strtoupper($area)); ?>
    ...
    <footer class="footer-section   text-sm pl-4 text-gray-500 h-72">
                ...
                <div class="flex justify-center p-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        ...
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-1 underline">
                                <?php echo e(__('sections.sponsor')); ?>
        ...
        <div class=" col-span-4 h-36 mx-auto pt-10">
            <?php $__currentLoopData = $menuitems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="col-span-1 font-semibold p-4" href="<?php echo e(env('APP_URL').'/'. $item['link']); ?>">
                    <?php echo e($item['title_ru']); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <section class="flex inline-flex w-full justify-between">
            <div class="my-auto">&copy; 1831-2022 <?php echo e(__('sections.museum')); ?> </div>
            <div class="mr-4   justify-between">
                <p>send mesage</p>
                <p>inform about error</p>
            </div>
        </section>
</footer>
...
<script type="text/javascript">
    function logging(){
        console.log('hello slavistics');
    }
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/app/rumuseum/resources/views/welcome.blade.php ENDPATH**/ ?>